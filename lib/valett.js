...
(function() {
  ...
  Valett = (function() {
    ...
    Valett.prototype._transitionFrequency = function() {
      var curLetter, i, j, letter, nextLetter, prevLetter, word, _i, _j, _k, _len, _ref, _ref1, _ref2, _results;
      ...
      for (_k = 0, _len = _ref2.length; _k < _len; _k++) {
        ...
        _results.push((function() {
          ...
          for (i = _l = 0, _len1 = word.length; _l < _len1; i = ++_l) {
            ...
            } else if (this.hash[word[i - 1]] != null) {
              prevLetter = this.hash[word[i - 1]];
            }
            if (i === word.length - 1) {
              nextLetter = this.letters.length;
            } else if (this.hash[word[i + 1]] != null) {
              nextLetter = this.hash[word[i + 1]];
            }
            if (this.hash[letter] != null) {
            ...
            if (curLetter != null) {
              if (prevLetter != null) {
                this.metadata.transitionFrequency[prevLetter][curLetter]++;
              }
              if (nextLetter != null) {
                _results1.push(this.metadata.transitionFrequency[curLetter][nextLetter]++);
              } else {
                _results1.push(void 0);
              }
            } else {
